...
pub const STAR_VERTICES: &[Vertex] = &[
    ...
    Vertex { position: [0.0, 0.5, 0.0], color: [1.0, 0.0, 0.0], tex_coords: [0.0, 0.0] },           // 0 - Top (90°)
    Vertex { position: [0.475528, 0.154509, 0.0], color: [0.0, 1.0, 0.0], tex_coords: [0.0, 0.0] }, // 1 - Right-upper (18°)
    Vertex { position: [0.293893, -0.404509, 0.0], color: [0.0, 0.0, 1.0], tex_coords: [0.0, 0.0] }, // 2 - Right-lower (-54°)
    Vertex { position: [-0.293893, -0.404509, 0.0], color: [1.0, 0.0, 1.0], tex_coords: [0.0, 0.0] }, // 3 - Left-lower (-126°)
    Vertex { position: [-0.475528, 0.154509, 0.0], color: [0.0, 1.0, 1.0], tex_coords: [0.0, 0.0] }, // 4 - Left-upper (162°)

    // Inner points (valleys between tips) - radius 0.2
    // Angles: 54°, -18°, -90°, -162°, 126°
    Vertex { position: [0.161803, 0.117557, 0.0], color: [1.0, 1.0, 0.0], tex_coords: [0.0, 0.0] },  // 5 - Between 0 and 1 (54°)
    Vertex { position: [0.061803, -0.190211, 0.0], color: [1.0, 0.5, 0.0], tex_coords: [0.0, 0.0] }, // 6 - Between 1 and 2 (-18°)
    Vertex { position: [0.0, -0.2, 0.0], color: [0.5, 1.0, 0.0], tex_coords: [0.0, 0.0] },           // 7 - Between 2 and 3 (-90°)
    Vertex { position: [-0.061803, -0.190211, 0.0], color: [0.0, 1.0, 0.5], tex_coords: [0.0, 0.0] }, // 8 - Between 3 and 4 (-162°)
    Vertex { position: [-0.161803, 0.117557, 0.0], color: [0.5, 0.0, 1.0], tex_coords: [0.0, 0.0] }, // 9 - Between 4 and 0 (126°)

    // Center point
    Vertex { position: [0.0, 0.0, 0.0], color: [1.0, 1.0, 1.0], tex_coords: [0.0, 0.0] },           // 10 - Center
];
